...
import { AppShell } from "../components/loadless/app-shell";
import { Toaster } from "../components/ui/sonner";
import { LoadLessDemoProvider } from "../hooks/use-loadless-demo";
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Easey — Know your capacity before you say yes" },
      {
        ...
        content:
          "See your real weekly workload, simulate new commitments, and protect your capacity.",
      },
